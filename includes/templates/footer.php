<footer class="site-footer">
    <div class="contenedor clearfix">
          <div class="footer-informacion">
              <h3>Sobre <span>Counseling Cba</span></h3>
              <p>Somos una institución fundadada en 2016 que tiene el objetivo de Formar Counselors a través de una construcción académica integral y humanista. Actualmente la institucion cuenta con mas de 100 alumnos, diversos cursos, seminarios y una tecnicatura para que alcances tu desarrollo personal al maximo</p>
          </div>
          <div class="ultimos-tweets">
              <h3>Menú <span>principal</span></h3>
              <nav class="navegacion-footer clearfix">
          ...
          <div class="menu">
              ...
              <nav class="redes-sociales">
                  <a href="https://www.facebook.com/counseling.cordoba"><i class="fa fa-facebook" aria-hidden="true"></i></a>
              </nav>
          </div>
    </div>
    
    <p class="copyright">
      Todos los derechos Reservados Counseling Cba.
    </p>
